...
- [MCP server reference](mcp.md) — the 69 tools an AI client can call, and which ones need BMM open
- [CLI reference](cli.md) — the same binary’s 62 subcommands, for a terminal or a `.bat`
