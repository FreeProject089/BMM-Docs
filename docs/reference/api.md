...
- [MCP server reference](mcp.md) — the 73 tools an AI client can call, and which ones need BMM open
- [CLI reference](cli.md) — the same binary’s 66 subcommands, for a terminal or a `.bat`
