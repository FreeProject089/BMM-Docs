...
utilise **Forcer**. Voir
[Le gouverneur de ressources](../how-it-works/resources.md#comment-marche-la-detection).
...
Voir [Sur quoi agit chaque colonne](../how-it-works/resources.md#sur-quoi-agit-chaque-colonne).
