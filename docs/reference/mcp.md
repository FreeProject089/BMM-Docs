...
[BMMScript](../features/bmmscript-reference.md) is the same task as text, and its compiler
...
- [CLI reference](cli.md) — the same executable’s other half: 62 subcommands for a terminal or a `.bat`
