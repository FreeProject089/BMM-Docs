...
[gouverneur de ressources](../how-it-works/resources.md) : l'endroit unique qui décide combien
...
| **Mode jeu** | **Le détecter**, **Forcer**, **Arrêter**. Tant qu'il est actif, BMM travaille comme en Silencieux, et les empreintes et la maintenance de fond attendent qu'il se termine. **Le détecter** cherche toutes les 5 secondes un jeu lancé depuis le dossier de jeu d'un de tes profils, un jeu que tu listes sous **Jeux surveillés par BMM**, ou tout jeu en plein écran exclusif, et termine le mode jeu 30 secondes après sa fermeture ([comment](../how-it-works/resources.md#comment-marche-la-detection)) |
...
!!! warning "Lis sur quoi agit chaque colonne avancée"
    ...
    [la page du gouverneur](../how-it-works/resources.md#sur-quoi-agit-chaque-colonne).
...
voir [L'intensité de travail de BMM](scheduler.md#lintensite-de-travail-de-bmm).
