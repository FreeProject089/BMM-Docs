...
| **Mode jeu** | **Le détecter**, **Forcer**, **Arrêter**. Tant qu'il est actif, BMM travaille comme en Silencieux, et les empreintes et la maintenance de fond attendent qu'il se termine. La détection automatique n'est pas encore branchée dans cette version : utilise **Forcer** ([pourquoi](../how-it-works/resources.md#le-mode-jeu)) |
...
!!! warning "Lis sur quoi agit chaque colonne avancée"
    ...
    sont sur [la page du gouverneur](../how-it-works/resources.md#sur-quoi-agit-chaque-colonne).
