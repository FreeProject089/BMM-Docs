...
!!! tip "Ouvrir dans BMM"
    ...
    L'application contient une version plus courte de cette page, à côté de l'éditeur qui
    s'en sert. [Ouvrir dans Aide &amp; autres](bmm://docs/open?article=bmmscript)
    — BMM doit déjà être lancé. [Ce que sont ces liens](../index.md#comment-marchent-les-liens-bmm)

> Les mêmes automatisations que les briques du [planificateur](scheduler.fr.md), écrites en
...
**[Toutes les actions, conditions et valeurs](bmmscript-reference.fr.md)** — la liste complète, générée depuis le registre de BMM pour qu'elle ne puisse pas devenir fausse.
