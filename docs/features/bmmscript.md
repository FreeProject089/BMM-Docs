...
!!! tip "Open in BMM"
    ...
    The app has a shorter version of this page, sitting next to the editor that uses it.
    [Open it in Help &amp; other](bmm://docs/open?article=bmmscript)
    — BMM must already be running. [What these links are](../index.md#how-the-bmm-links-work)

> The same automations as the [scheduler's](scheduler.md) bricks, written as text. Anything
