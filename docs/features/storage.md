...
[resource governor](../how-it-works/resources.md): the one place that decides how many heavy
...
| **Game mode** | **Detect it**, **Force on**, **Force off**. While it is on, BMM works as if on Quiet, and background hashing and maintenance wait until it ends. Automatic detection is not connected yet in this version: use **Force on** ([why](../how-it-works/resources.md#game-mode)) |
...
!!! warning "Read what each advanced column acts on"
    ...
    Windows yet. Details in [the governor page](../how-it-works/resources.md#what-each-column-acts-on).
...
| **Profile pills** | Which [profiles](profiles.md) use the disk, and how (destination folder / mod folder / backup). |
...
[How hard BMM works](scheduler.md#how-hard-bmm-works).
