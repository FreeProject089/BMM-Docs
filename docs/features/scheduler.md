...
| **Benchmarks & storage** | Run an app benchmark · **benchmark a disk** · **apply a disk speed limit** · toggle **Smart I/O** / **Auto-Calibration** · **check free disk space** (see [Storage](storage.md)) · **set the resource preset**, **game mode**, **pause or resume the queue** (see [below](#how-hard-bmm-works)) |
...
Three actions and three conditions drive the [resource governor](../how-it-works/resources.md),
