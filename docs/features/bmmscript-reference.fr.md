...
La grammaire elle-même qui, contrairement à tout ce qui précède, est fixe. L'explication complète de chacune est sur la [page principale BMMScript](bmmscript.fr.md).
