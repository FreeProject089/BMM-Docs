...
!!! note "Smart I/O compte encore sous Équilibré"
    ...
    Voir [Performances](performance.md).
...
!!! warning "Un déploiement dans le processus séparé s'annule, il ne se suspend pas"
    ...
    ([Performances](performance.md#sortir-le-travail-lourd-de-la-fenetre)). L'app garde le ticket
...
[Planification & automatisation](../features/scheduler.md#lintensite-de-travail-de-bmm).
...
Les routes, outils et commandes sont listés dans la [Référence API](../reference/api.md), la
[Référence du serveur MCP](../reference/mcp.md) et la [Référence CLI](../reference/cli.md).
